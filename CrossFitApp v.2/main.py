...
if __name__ == '__main__':
    ...
    # userRepo = UsersRepository(id_gen, 'users_db.json', 'cls')
    # u1 = Users('Ivan', 'Vanko', 'Vankow', 'alabala', 'male', '1')
    # u2 = Users('Ivan2', 'Vanko2', 'Vankow2', 'alabala2', 'male', '1')
    # u3 = Users('Ivan3', 'Vanko3', 'Vankow3', 'alabala3', 'male', '2')
    # userRepo.create(u1)
    # userRepo.create(u2)
    # userRepo.create(u3)
    #
    ...
    workout_repo = WorkoutsRepository('workouts.json', Workouts)
    workout_service = WorkoutService(workout_repo)
    workout_controller = WorkoutController(workout_service)
